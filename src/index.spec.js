...
describe("toSvg test", function() {
  it("should produce an SVG", function(done) {
    ...
    const props = JSON.parse(
      fs.readFileSync("./src/testdata/props.json", "utf8")
    );
    const stacks = JSON.parse(
      fs.readFileSync("./src/testdata/stacks.json", "utf8")
    );
...
describe("runConfig test", function() {
  it("should produce an SVG", function(done) {
    const config = JSON.parse(
      fs.readFileSync("./configs/hilbert.json", "utf8")
    );
    const expected = fs.readFileSync(
      "./src/testdata/hilbert-expected.svg",
      "utf8"
    );
